...
const Notification = () => {
  ...
  return (
    <div className='nav-item absolute right-36 top-16 bg-white shadow-2xl w-96 p-8'>
      <div className='flex justify-between items-center border-blue-500 border-xl rounded-md'>
      ...
      <div className='mt-5'>
        ...
        <div className="mt-6">
            <Button color="white" bgColor={currentColor} text="Download" borderRadius="10px" size="md" className="w-full"/>
          </div>
      </div>
